	...
	<div class="page-content">
			...
			if (empty($_GET['church'])) {
				...
				if (get_church_by_name($_GET['church'])) {
					...
					echo 'You are filling out an application to be a Protégé with Men of Iron at '. $church['post_title'] .'. If this is incorrect please contact your Men of Iron program director.';
