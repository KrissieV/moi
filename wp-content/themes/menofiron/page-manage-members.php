...
<div class="page-content">
			...
			if (empty($_GET['church'])) {
				echo 'There is no church associated with this members page. Please contact Men of Iron to get a link to your church specific members management page.';
			} else {
				...
				if (get_church_by_name($_GET['church'])) {
					...
					if ($users_church[0] == $_GET['church'] || current_user_can( 'manage_options' )) {
						echo 'You are managing the members at '. $church['post_title'] .'. If this is incorrect please contact Men of Iron.';
				 ...
				 echo 'There is no church matching this record. Please contact Men of Iron.';
				}
